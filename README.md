...
- 액티비티를 소개, 공유, 판매하는 플랫폼으로서 판매부터 추천기능, 원하는 액티비티 저장 및 참여 후 후기를 남길 수 있는 등 다양한 서비스를 제공합니다.
  따라서 다양한 서비스를 제공하는 만큼 다양한 기능들이 홈페이지 내에 탑재되어 있어 여러 기술들을 적용해보기 적합하다고 생각하였습니다.
